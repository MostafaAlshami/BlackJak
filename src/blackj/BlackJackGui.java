		...
		if (dealerHand != null) {
			for (int i=0; i < dealerHand.size(); i++) {
				...
				if (gameOn) {
					...
					if (i == 0) {
						image = new ImageIcon("C:\\Users\\Mostafa\\Downloads\\AymanTarneeb\\Cards\\"+i+".png").getImage();
                                                
       Image temp_img=image.getScaledInstance(2500, 1000, Image.SCALE_SMOOTH);

       JLabel background=new JLabel("", (Icon) image,JLabel.CENTER);
